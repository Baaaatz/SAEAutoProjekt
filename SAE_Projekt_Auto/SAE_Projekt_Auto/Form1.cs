...
namespace SAE_Projekt_Auto
{
    ...
    {   //Marvin
        ...
        //Daniel
        string startupPath = Environment.CurrentDirectory;                                                   //gibt den Pfad zurück, in dem die ausführte Datei liegt
        ...
        private void btSpeichern_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                AutolisteSpeichern.RemoveAt(AutolisteSpeichern.Count - 1);                                     //löscht Objekt aus AutolisteSpeichern
        ...
        private void SchreibeInCSV(List<Wagen> autolisteSpeichern)
        {
            ...
            {                           
                foreach (Wagen auto in autolisteSpeichern)                                                        //Durchläuft jedes Objekt der liste AutolisteSpeichern
                {
        ...
        private void btSuchen_Click(object sender, EventArgs e)
        {
            ...
            rtbHauptausgabe.Text = "";                                                                                                               // Gib die Übereinstimmungen in der Hauptausgabe aus
            ...
            try
            {
                ...
                using (StreamReader reader = new StreamReader(dateiPfad))                             // Lese die CSV-Datei Zeile für Zeile
                {
                    ...
                    while ((line = reader.ReadLine()) != null)
                    {
                        ...
                        Wagen wagen = new Wagen                                                       // Erstellt ein neues Objekt und füllt es mit den Daten der CSV-Datei
                        {
                            Marke = parts[0],
                            Modell = parts[1],
                        ...
                        AutolisteSuchen.Add(wagen);                                                    // Fügt das Objekt der Liste hinzu
                    }
                }
            }
            catch (Exception ex)
